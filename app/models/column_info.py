...
class ColumnInfoMySQL(Base):
    ...
    table_id: Mapped[str | None] = mapped_column(
        ForeignKey("table_info.id"), comment="所属表编号"
    )

    table: Mapped["TableInfoMySQL | None"] = relationship(back_populates="columns")
    metrics: Mapped[List["ColumnMetricMySQL"]] = relationship(
